...
//    _lineView = [[UIView alloc] initWithFrame:CGRectMake(20, self.buttonHeight - self.bottomLineHeight, self.buttonWidth - 40, self.bottomLineHeight)];
