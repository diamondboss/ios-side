//
//  AgreeementViewController.m
//  DiamondBoss
//
//  Created by wendf on 2017/7/22.
...
@interface AgreeementViewController ()<UIWebViewDelegate>
@property (nonatomic,strong) UIWebView *webView;
@property (nonatomic,strong) LMWebProgressLayer *progressLayer;

@end

@implementation AgreeementViewController
...
- (void)popTo{
    AppointmentViewController *con = [[AppointmentViewController alloc]init];
...
- (void)setupUI {
    ...
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://45.63.121.99/#/service-agreement"]]];
