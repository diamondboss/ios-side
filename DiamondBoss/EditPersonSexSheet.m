...
@interface EditPersonSexSheet()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation EditPersonSexSheet
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    ...
    self.sexStr = self.dayArr[row%[self.dataArray[component] count]];
